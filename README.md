...
```bash
git clone https://github.com/esyacelga/devsu-app.git
cd devsu-app
```
...
El archivo `Devsu endpoint.postman_collection.json` contiene una colección de pruebas para Postman.

1. Importa este archivo en Postman:
    - Ve a **File > Import** en Postman.
    - Selecciona el archivo `Devsu endpoint.postman_collection.json`.
...
3. Importar y ejecutar pruebas:
    - Usar Postman con el archivo `Devsu endpoint.postman_collection.json`.
